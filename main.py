...
st.title('HEXtoLAB_Japanese_Autumn')
...
hex_colors = [
    ...
    "#b36559", "#8d1011", "#6a110c", "#bf3120", "#d35e2a",
    "#b05316", "#e2b437", "#b37d27", "#998234", "#635f39",
    "#8b8d77", "#919a3f", "#434e23", "#194220", "#172219", 
    "#254f45", "#0c2320", "#055b93", "#064262", "#033164",
    "#e0d9c1", "#c2b7a1", "#7c6a46", "#4d3c1f", "#401e13",
    "#24130c", "#261c13", "#3c3e30"
]
...
# === CSVファイルに保存 ===
csv_filename = 'hex_to_lab_colors_Japanese_autumn.csv'
df.to_csv(csv_filename, index=False)

# === CSVダウンロードボタン ===
st.write("### HEXカラーとL* a* b* 座標のCSV出力_Japanese_autumn")
st.download_button(
    label="CSVをダウンロード",
...
# === Streamlitで3Dグラフ表示 ===
st.write("### L* a* b* 色空間 3D可視化_Japanese_autumn")
st.plotly_chart(fig)
